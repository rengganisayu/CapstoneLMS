...
<head>
  ...
  <script>
    ...
    function submitTask() {
      ...
      alert(`Tugas "${title}" disimpan dengan deadline: ${new Date(deadline).toLocaleString("id-ID")}`);
      closeOverlay();
    }
  </script>
</head>
...
<div class="container">
    ...
    @csrf
    <button class="add-btn" type="button" onclick="triggerFileUpload()">+ Tambah File</button>
    <input type="file" name="file" id="fileUploadInput" style="display: none" onchange="handleFileChange(event)">
    <span id="fileNameDisplay">Tidak ada file yang dipilih</span>
    <button type="submit" class="add-btn">Upload File</button>
...
<script>
function triggerFileUpload() {
  // Men-trigger input file ketika tombol ditekan
  document.getElementById("fileUploadInput").click();
}

function handleFileChange(event) {
  // Menangani perubahan pada input file dan menampilkan nama file
